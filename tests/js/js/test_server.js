...
(function() {
  ...
  QUnit.test("translate_request test", function(assert) {
    ...
    return conn.request_translation(JSON.stringify(diag.to_json()), "owllink", "berardi", function(data) {
      var actual;
