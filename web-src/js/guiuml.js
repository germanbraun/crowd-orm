...
GUIUML = (function(superClass) {
  ...
  function GUIUML(graph, paper) {
    ...
    this.paper = paper;
    this.urlprefix = "";
    this.diag = new UMLDiagram(this.graph);
  ...
  GUIUML.prototype.show_error = function(status, error) {
    $.mobile.loading("hide");
  ...
  GUIUML.prototype.translate_owllink = function(gui_instance) {
    ...
    return this.serverconn.request_translation(json, format, function(data) {
      return gui_instance.update_translation(data);
    });
  };

  GUIUML.prototype.change_to_details_page = function() {
    return $.mobile.changePage("#details-page", {
      transition: "slide"
    });
  };

  GUIUML.prototype.change_to_diagram_page = function() {
  ...
  GUIUML.prototype.hide_toolbar = function() {
  ...
  GUIUML.prototype.show_export_json = function() {
    this.exportjsonwidget.set_jsonstr(this.diag_to_json());
    $(".exportjson_details").collapsible("expand");
    return this.change_to_details_page();
  };

  GUIUML.prototype.refresh_export_json = function() {
    return this.exportjsonwidget.set_jsonstr(this.diag_to_json());
  };

  GUIUML.prototype.show_import_json = function() {
    this.hide_toolbar();
    return this.importjsonwidget.show();
  };

  GUIUML.prototype.show_insert_owllink = function() {
    return this.change_to_details_page();
  };

  GUIUML.prototype.set_insert_owllink = function(str) {
  ...
  GUIUML.prototype.import_jsonstr = function(jsonstr) {
    var json;
