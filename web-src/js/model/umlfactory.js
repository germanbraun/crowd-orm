...
UMLFactory = (function(superClass) {
  ...
  UMLFactory.prototype.create_class = function(class_name, attrs, methods, css_class) {
    var newclass, params;
    if (css_class == null) {
      css_class = null;
    }
...
create_association_link(css_assoc_links)(function() {
  var link;
  link = new joint.dia.Link({
    source: {
      x: 10,
